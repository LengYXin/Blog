...
@inject('highqualityStore')
@observer
export class HighqualityComponent extends React.Component<any, any> {
    ...
    render() {
        ...
        if (this.props.highqualityStore.highquality.playlists.length) {
            const { selectedTags } = this.state;
            return (
                <QueueAnim key="queue"
                    leaveReverse
                >
                    ...
                    <Card>
                        {this.props.highqualityStore.highquality.playlists.map(x => {
